...
const content = {
  vi: {
    ...
    feeItems: [
      ...
      ["Web", "management dashboard", "Theo dõi thẻ, ngân sách, giao dịch và chi tiêu quảng cáo trong một dashboard.", BarChart3, "from-cyan-400/20 to-cyan-500/5", "text-cyan-300", "border-cyan-400/20"],
    ],
